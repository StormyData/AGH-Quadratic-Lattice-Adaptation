...
class P3(Production):
    ...
    def get_right_side(self, left: Graph, lvl: int):
        ...
        n7 = Node(n1.x, (n1.y + n4.y)/2, f"{lvl}n7", hanging=not hn6.hyperref.boundary)
        n8 = Node((n3.x + n4.x)/2, n3.y, f"{lvl}n8", hanging=not hn5.hyperref.boundary)
        ...
        g.add_edge(HyperEdge((n8, n4), "E", boundary=hn5.hyperref.boundary))
        g.add_edge(HyperEdge((n4, n7), "E", boundary=hn6.hyperref.boundary))
        g.add_edge(HyperEdge((n7, n1), "E", boundary=hn6.hyperref.boundary))
