...
class P3(Production):
    ...
    def get_right_side(self, left: Graph, lvl: int) -> Graph:
        n1, n2, n3, n4, n5, n6, hn1n6, hn6n2, hn2n5, hn5n3, hn3n4, hn4n1, _ = left.ordered_nodes
        g = Graph()
        ...
        n5.hanging = False # TODO this is readonly
        n6.hanging = False # TODO this is readonly

        for n in [n1, n2, n3, n4, n5, n6, n7, n8, n9]:
            g.add_node(n)

        g.add_edge(HyperEdge((n1, n6), "E", boundary=hn1n6.hyperref.boundary))
        g.add_edge(HyperEdge((n6, n2), "E", boundary=hn6n2.hyperref.boundary))
        ...
        g.add_edge(HyperEdge((n4, n7), "E", boundary=hn4n1.hyperref.boundary))
        g.add_edge(HyperEdge((n7, n1), "E", boundary=hn4n1.hyperref.boundary))
        ...
        g.add_edge(HyperEdge((n1, n6, n9, n7), "Q"))
        g.add_edge(HyperEdge((n6, n2, n5, n9), "Q"))
        g.add_edge(HyperEdge((n9, n5, n3, n8), "Q"))
        g.add_edge(HyperEdge((n7, n9, n8, n4), "Q"))
        return g
